...
import (
	...
	"db-seeder/walker/code-diagnostic/assignments"
	"db-seeder/walker/code-diagnostic/classes"
	"db-seeder/walker/code-diagnostic/conditionals"
	"db-seeder/walker/code-diagnostic/functions"
	"db-seeder/walker/code-diagnostic/imports"
	"db-seeder/walker/code-diagnostic/returns"
